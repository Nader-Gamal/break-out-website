...
function switchLanguage() {
    ...
    if (currentLanguage === 'ar') {
      ...
      document.querySelector('button').innerHTML = 'تغيير اللغة';
    } else {
      document.documentElement.lang = 'ar';
      document.querySelector('p').innerHTML = 'أهلاً بالعالم';
      document.querySelector('button').innerHTML = 'Switch Language';
    }
  }
